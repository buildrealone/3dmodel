const MainScene = () => {
    ...
    <a-scene vr-mode-ui="enabled: true;" loading-screen="enabled: false;">
      ...
      <a-entity gltf-model="url(/assets/models/trex_lowq/scene.gltf)" scale="0.7 0.7 0.7" 
      rotation="0 -10 0" animation="property: position; from:-14 0 -30.5; to:-14 0 -14;loop: -1; dur:6000" animation-mixer="clip: Take 001; loop: infinite; timeScale: 1.0; crossFadeDuration: 1;" />
      <a-entity gltf-model="url(/assets/models/trex_lowq/scene.gltf)" scale="0.7 0.7 0.7" 
      rotation="0 -10 0" animation="property: position; from:-10.5 0 -30.5; to:-10.5 0 -14;loop: -1; dur:6000" animation-mixer="clip: Take 001; loop: infinite; timeScale: 1.0; crossFadeDuration: 1;" />
      <a-entity gltf-model="url(/assets/models/trex_lowq/scene.gltf)" scale="0.7 0.7 0.7" 
      rotation="0 -10 0" animation="property: position; from:-7 0 -30.5; to:-7 0 -14;loop: -1; dur:6000" animation-mixer="clip: Take 001; loop: infinite; timeScale: 1.8; crossFadeDuration: 1;" />
      <a-entity gltf-model="url(/assets/models/trex_lowq/scene.gltf)" scale="0.7 0.7 0.7" 
      rotation="0 -10 0" animation="property: position; from:-3.5 0 -30.5; to:-3.5 0 -14;loop: -1; dur:6000" animation-mixer="clip: Take 001; loop: infinite; timeScale: 1.3; crossFadeDuration: 1;" />
      {/* <a-entity light="type: ambient; intensity: 1">
        <a-entity light="type: point; intensity: 2; position: 0 0 -8"> */}
          <a-entity gltf-model="url(/assets/models/trex_lowq/scene.gltf)" scale="1 1 1" 
          animation="property: position; from:0 0 -30; to:0 0 -13.5;loop: -1; dur:6000" animation-mixer="clip: Take 001; loop: infinite; timeScale: 1.1; crossFadeDuration: 1;" />
        {/* </a-entity>
      </a-entity> */}
      <a-entity gltf-model="url(/assets/models/trex_lowq/scene.gltf)" scale="0.7 0.7 0.7" 
      rotation="0 10 0" animation="property: position; from:3.5 0 -30.5; to:3.5 0 -14;loop: -1; dur:6000" animation-mixer="clip: Take 001; loop: infinite; timeScale: 1.5; crossFadeDuration: 1;" />
      <a-entity gltf-model="url(/assets/models/trex_lowq/scene.gltf)" scale="0.7 0.7 0.7" 
      rotation="0 10 0" animation="property: position; from:7 0 -30.5; to:7 0 -14;loop: -1; dur:6000" animation-mixer="clip: Take 001; loop: infinite; timeScale: 1.7; crossFadeDuration: 1;" />
      <a-entity gltf-model="url(/assets/models/trex_lowq/scene.gltf)" scale="0.7 0.7 0.7" 
      rotation="0 10 0" animation="property: position; from:10.5 0 -30.5; to:10.5 0 -14;loop: -1; dur:6000" animation-mixer="clip: Take 001; loop: infinite; timeScale: 1.4; crossFadeDuration: 1;" />
            <a-entity gltf-model="url(/assets/models/trex_lowq/scene.gltf)" scale="0.7 0.7 0.7" 
      rotation="0 10 0" animation="property: position; from:14 0 -30.5; to:14 0 -14;loop: -1; dur:6000" animation-mixer="clip: Take 001; loop: infinite; timeScale: 1.4; crossFadeDuration: 1;" />
